				...
				<tbody id="itemsBody" data-items-body>
					<?php foreach ($defaultItems as $index => $item): ?>
						<tr data-item-row>
							...
							<td><div class="editable-cell" contenteditable="true" data-field="name"><?= h($item['name'] ?? '') ?></div><input type="hidden" name="items[<?= h($index) ?>][name]" data-hidden-field="name" value="<?= h($item['name'] ?? '') ?>"></td>
		...
		<template id="itemRowTemplate">
			<tr data-item-row>
				<td><div class="editable-cell" contenteditable="true" data-field="reference"></div><input type="hidden" name="items[__INDEX__][reference]" data-hidden-field="reference" value=""></td>
						<td><div class="editable-cell" contenteditable="true" data-field="name"></div><input type="hidden" name="items[__INDEX__][name]" data-hidden-field="name" value=""></td>
