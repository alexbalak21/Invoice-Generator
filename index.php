...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-12 col-lg-10">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <a class="action-card action-card-invoice h-100 text-decoration-none" href="form.php?type=invoice">
                ...
                <div class="col-md-6">
                    <a class="action-card action-card-quote h-100 text-decoration-none" href="form.php?type=quote">
